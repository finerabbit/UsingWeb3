...
console.log(oneSplitABI);

onesplitContract.methods.getExpectedReturn(fromToken, toToken, new BigNumber(amountToExchange).shiftedBy(fromTokenDecimals).toString(), 100, 0).call({ from: '0x97c7ce63299EE389C3f73C44C56f3E0C3aB48D25' }, function (error, result) {
    if (error) {
        console.log(error)
        return;
    }
